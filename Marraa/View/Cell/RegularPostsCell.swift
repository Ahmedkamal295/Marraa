...
class RegularPostsCell: UITableViewCell {
    ...
    func configureCell(adModel:AdModel){
        ...
        if adModel.images.count != 0 { self.adPictureImageView.setImageWith(adModel.images[0].addingPercentEncoding(withAllowedCharacters: CharacterSet.urlQueryAllowed))
        }

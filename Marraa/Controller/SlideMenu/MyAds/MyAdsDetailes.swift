        ...
        API.POST(url: URLs.AdvPage, parameters: body, headers: nil) { (success, value) in
            if success{
                ...
                if let adv = dict["adv"] as? [String:Any]{
                    ...
                    //fill UI
//                    if images?.count != 0 {
//                        self.advPictureImageView.setImageWith(images![0].addingPercentEncoding(withAllowedCharacters: CharacterSet.urlQueryAllowed))
//                    }else{
//                        self.advPictureImageView.setImageWith(thumbnail.addingPercentEncoding(withAllowedCharacters: CharacterSet.urlQueryAllowed))
//                    }
                    if images != nil {
...
//                    self.videoLink.text =
    ...
    @objc func contextMenuBtnPressed(){
        ...
        //        self.contextMenuTableView!.backgroundColor = UIColor.clear
...
//            vc.advPic = UIImagePNGRepresentation((self.advPictureImageView.image)!)! as Data
//            vc.imageAdv = self.advPictureImageView.image
            vc.advId = self.advId!

...
//        let downloadURL2 = URL(string: uploadsURL + (blog?.image)!)
//        if downloadURL2 != nil {
//            self.blogImage.kf.setImage(with: downloadURL2)
//        }
//        return self.blogImage.image
    ...
    @objc func tapUserDetailes(_ recognizer: UITapGestureRecognizer){
        print(0)
        //TODO: make transition to another page

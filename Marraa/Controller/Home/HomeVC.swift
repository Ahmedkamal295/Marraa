...
//        birdsCollectionView.transform = CGAffineTransform(rotationAngle: -CGFloat.pi)
...
//        sideMenu()
    ...
    func sideMenu(){
//        let vc =  UIApplication.shared.keyWindow?.viewContainingController()

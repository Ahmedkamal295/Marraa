...
class AddAdvVC: UIViewController {
    ...
    //regular textfields without pickerviews
...
//        let coloredImage = UIImage(color: UIColor(displayP3Red: 73/255, green: 173/255, blue: 233/255, alpha: 1))
...
//                        let b = [
//                            "post_id": value["post_id"] as! Int
//                        ]
//                        API.POSTImage(url: "https://www.marraa.com/wp-json/wp/v2/publish/upload", Images: [self.advPic!], Keys: ["file"], header: header, parameters: b, completion: { (s, v) in
//                            print(v)
//                        })
...
//                addImageLabel.text = self.advPicsArray.joined()
            }else{
